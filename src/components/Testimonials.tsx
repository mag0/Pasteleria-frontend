...
const Testimonials = () => {
    ...
    return (
        <section className="py-20 bg-[#9E3A66]/50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-serif font-bold text-white">Lo que dicen nuestros clientes</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {testimonials.map((t, idx) => (
                        <div key={idx} className="bg-[#FDF6F0] border border-[#C9A227]/20 p-6 rounded-md shadow-lg">
